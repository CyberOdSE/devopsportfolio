                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <form action="{{ route('register.post') }}" method="POST">
                                ...
                                <div class="form-group row">
                                    <label for="is_admin" class="col-md-4 col-form-label text-md-right">Account Type:</label>
                                    <div class="select col-md-6 @error('is_admin') is-danger @enderror">
                                        <select class="col-md-6" name="is_admin"  id="is_admin">
                                            <option value="0"  {{ old('is_admin') == 0 ? "selected" : ''}}>Normal User </option>
